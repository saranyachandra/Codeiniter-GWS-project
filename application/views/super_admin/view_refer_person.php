						...
						<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title"  style="font-size: 27px;">View Refer Person</h4>
                                    </div>
                                    ...
                                    <table  id="table_view" class="table table-striped table-bordered">
                                        ...
                                        <thead>
                                            ...
                                            <tr>                                               
                                                ...
                                                <td> <?php echo $detail->refer_id; ?> </td> 
                                                <td> <?php echo $detail->user_id; ?> </td>         
                                                <td><?php echo $detail->r_name; ?></td> 
                                                 <td><?php echo $detail->r_email; ?></td>                                 
                                                <td><?php echo $detail->r_phone; ?></td>
    ...
    $.ajax({
                            ...
                            success: function(response)
                            {
                               if(response.status == 'success')
                               {
                                 ...
                                 window.location.href = "<?php echo base_url('super_admin/view_refer_person'); ?>";
