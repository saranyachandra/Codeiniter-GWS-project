...
<head>
    ...
    <title>Yung Pharma - Admin Dashboard </title>
    <!-- Favicon icon -->
				...
				<div class="tab-content" id="menu">
					...
					<div class="tab-pane fade" id="components">
						<ul class="metismenu tab-nav-menu">
							...
							<li>
								<a class="has-arrow" href="create-offer.html" aria-expanded="false">
											...
											<table class="table table-responsive-sm mb-0">
												...
												<tbody>
													<tr>
														...
														<td>Dr. Jackson Jackson</td>
														<td>9876543210</td>
														<td><b>$542</b></td>
														
														<td>
															<a href="#" class="btn btn-primary shadow sharp mr-1">Create Offer</a>
