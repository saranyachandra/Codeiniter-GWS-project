                   ...
                   <li class="nav-item">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link active" data-toggle="tab" href="#apps" >
                            <svg id="icon-pages" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><path width="7" height="7" d="M3 3 L10 3 L10 10 L3 10 Z" style="stroke-dasharray: 28, 48; stroke-dashoffset: 0;"></path><path width="7" height="7" d="M14 3 L21 3 L21 10 L14 10 Z" style="stroke-dasharray: 28, 48; stroke-dashoffset: 0;"></path><path width="7" height="7" d="M14 14 L21 14 L21 21 L14 21 Z" style="stroke-dasharray: 28, 48; stroke-dashoffset: 0;"></path><path width="7" height="7" d="M3 14 L10 14 L10 21 L3 21 Z" style="stroke-dasharray: 28, 48; stroke-dashoffset: 0;"></path></svg>
                            <span style="font-size: 12px;text-align: center;">Admin  </span> 
                        </a>
                    </li>     
                    <li class="nav-item">
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                <?php 
                                                        ...
                                                        {
                                                            if($detail->user_type!='super_admin')
                                                            {
                                            ...
                                            <tr>                                               
                                                ...
                                                <td>                                                    
                                                    <SELECT name="status" id="dropdown1_id" data-id="<?php echo $detail->super_id; ?>" >
                                                        <option value="0" <?php if($detail->active==0) echo 'selected="selected"'; ?>>Pending</option>
                                                ...
                                                <td>                                              
                                                    <div class="d-flex"> 
                                                   <button onclick="showAjaxModal('<?php echo base_url();?>super_admin/edit_admin_by_id/<?php echo $detail->super_id ?>');" class="btn btn-primary shadow btn-xs sharp mr-1" value="<?php echo $detail->super_id; ?>">
                                                           <i class="fa fa-pencil"></i>
                                                    </button>
                                                   
                                                     <form class="delete_id" action="<?php echo base_url('super_admin/delete_user_by_id/'.$detail->super_id); ?>" method="POST" style="float: left;">
    ...
    $.ajax({
                            ...
                            success: function(response)
                            {
                               if(response.status == 'success')
                               {
                                 ...
                                 Swal.fire('Admin successfully approved...');    
