        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="nav menu-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#Refer" >
					...
					<li class="nav-item">
						<a class="nav-link " data-toggle="tab" href="#forms" >
							<svg id="icon-forms" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" style="stroke-dasharray: 66, 86; stroke-dashoffset: 0;"></path><path d="M14,2L14,8L20,8" style="stroke-dasharray: 12, 32; stroke-dashoffset: 0;"></path><path d="M16,13L8,13" style="stroke-dasharray: 8, 28; stroke-dashoffset: 0;"></path><path d="M16,17L8,17" style="stroke-dasharray: 8, 28; stroke-dashoffset: 2;"></path><path d="M10,9L9,9L8,9" style="stroke-dasharray: 2, 22; stroke-dashoffset: 12;"></path></svg><span style="font-size: 12px;text-align: center;">Report  </span>   
						</a>
					</li>					
				</ul>
			</div>
						...
						<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title"  style="font-size: 27px;">View Refer Doctor</h4>
                                    </div>
                                    ...
                                    <table  id="table_view" class="table table-striped table-bordered">
                                        ...
                                        <thead>
                                            ...
                                            <tr>                                               
                                                ...
                                                <td> <?php echo $detail->doc_refer_id; ?> </td> 
                                                <td> <?php echo $detail->user_id; ?> </td>         
                                                <td><?php echo $detail->doc_name; ?></td> 
                                                 <td><?php echo $detail->doc_email; ?></td>                                 
                                                <td><?php echo $detail->doc_phone; ?></td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>                                                    
                                                    <SELECT name="status" id="dropdown1_id" data-id="<?php echo $detail->id; ?>" >
                                                        ...
                                                        <option value="1" <?php if($detail->status==1) echo 'selected="selected"';?>>Approved</option>
                                                    </SELECT>                                               
                                                </td>                                                
                                            </tr> 
   ...
   var id= $(this).data("id");
    ...
    $.ajax({
                            ...
                            success: function(response)
                            {
                               ...
                               {                                
                                 window.location.href = "<?php echo base_url('super_admin/view_refer_doctor'); ?>";                                                                  
                                }else 
                                 {                    
