						...
						<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h2 class="card-title" style="font-size: 27px;">Refer New Person</h2>
									</div>
									<div class="card-body">
									   <form action="<?php echo base_url('user/create_new_user');?>" class="create-user step-form-horizontal" method="POST">
                                    	<div>                                        
                                        <section>
                                            <div class="row">                                               
                                                ...
                                                <div class="col-lg-12 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="refer_id_1" name="r_phone" minlength="10" maxlength="10" class="form-control" onkeypress="return isNumberKey(event)" onkeyup="checkname();" placeholder="Enter Phone Number" >
...
function checkname() {   
 var name=document.getElementById("refer_id_1").value;  
 if(name)
 {
      $.ajax({
      type: 'post',
      url: '<?php echo base_url('user/check_refer_id'); ?>',
      data: {
       user_name:name,
      },
