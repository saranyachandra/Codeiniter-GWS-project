							...
							<div class="col-xl-4 col-xxl-4 col-lg-6 col-sm-6">
								<div class="card overflow-hidden">
									<div class="card-body pb-0 px-4 pt-4">
										<div class="row">
											<div class="col">
												<h5 class="mb-1"><?php echo $total_offer->tot_off; ?></h5>
												<span class="text-success">Total amount in GWS account</span>
											</div>
										</div>
									</div>
									...
									<div class="card-body pb-0 px-4 pt-4">
										<div class="row">
											<div class="col text-white">
												<h5 class="text-white mb-1"><?php echo "₹"." ".$tot_val->total; ?></h5>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="form-group text-center">
											<a href="<?php echo base_url('user/get_order_details') ?>" class="btn btn-info"> View All</a>
										</div>
								</div>
							</div>
					...
					<div class="col-xl-4 col-xxl-4 col-lg-12 col-md-12">
						<div class="card bg-primary text-white">
                            <div class="card-header pb-0 border-0">
                                <h4 class="card-title text-white">Up Coming Orders</h4>
                            </div>
                            <div class="card-body"> 
                                <div class="widget-media">
                                    <ul class="timeline">
                                    	<?php
                                    		if(isset($upcoming_order))
                                    		{
                                    		$i=1; 
                                    		foreach ($upcoming_order as  $up_orders) {  
                                            ...
                                            <div class="timeline-panel">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1 text-white" style="text-transform: capitalize;">
														<?php echo $up_orders->amount; ?>
													</h5>
													<small class="d-block">
													<?php echo $up_orders->create_at; ?>
													</small>
												</div>
