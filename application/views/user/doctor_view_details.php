						...
						<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h4 class="card-title"  style="font-size: 27px;">View  Refer Doctor Details</h4>
                                    ...
                                    <table  id="table_view" class="table table-striped table-bordered">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                   <?php echo $detail->doc_refer_id; ?>
                                                </td>                                             

                                                <td >
                                                   
                                                   <span id="username<?php echo $detail->user_id; ?>" ><?php echo $detail->doc_name; ?></span>
                                                </td>

                                                <td>                                              
                                                    <span id="email<?php echo $detail->user_id; ?>"><?php echo $detail->doc_email; ?></span>
                                                </td>

                                                <td>
                                                    <span id="phone<?php echo $detail->user_id; ?>"><?php echo $detail->doc_phone; ?></span>
                                                </td>                                   
                                                ...
                                                <td>                                              
                                                    <div class="d-flex"> 
                                                   <button onclick="showAjaxModal('<?php echo base_url();?>user/edit_doc_by_id/<?php echo $detail->id ?>');" class="btn btn-primary shadow btn-xs sharp mr-1" value="<?php echo $detail->id; ?>">
                                                           <i class="fa fa-pencil"></i>
                                                    </button>
                                                   
                                                     <form class="delete_id" action="<?php echo base_url('user/delete_doc_by_id/'.$detail->id); ?>" method="POST" style="float: left;">
