                                    ...
                                    <table  id="table_view" class="table table-striped table-bordered">
                                        ...
                                        <thead>
                                            ...
                                            <tr>                                               
                                               ...
                                               <td>                                                   
                                                   <span id="username<?php echo $detail->user_id; ?>" ><?php echo $detail->user_name; ?></span>
                                                </td>
                                                <td>                                              
                                                    <span id="email<?php echo $detail->user_id; ?>"><?php echo $detail->email; ?></span>
                                                </td>
                                                <td>
                                                    <span id="phone<?php echo $detail->user_id; ?>"><?php echo $detail->phone; ?></span>
                                                </td>                                   
                                                ...
                                                <td>                                              
                                                    <div class="d-flex"> 
                                                   <button onclick="showAjaxModal('<?php echo base_url();?>admin/edit_user_by_id/<?php echo $detail->user_id ?>');" class="btn btn-primary shadow btn-xs sharp mr-1" value="<?php echo $detail->id; ?>">
                                                           <i class="fa fa-pencil"></i>
                                                    </button>
                                                   
                                                     <form class="delete_id" action="<?php echo base_url('admin/delete_user_by_id/'.$detail->id); ?>" method="POST" style="float: left;">
